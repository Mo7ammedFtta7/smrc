...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu tree" data-widget="tree">
      ...
      <li><a href="<?php echo e(guard_url('settings/setting')); ?>"><i class="fa fa-sliders text-red"></i> <span>Settings</span></a></li>
      <li><a href="<?php echo e(guard_url('masters')); ?>"><i class="fa fa-circle-o text-yellow"></i> <span>Masters</span></a></li>
