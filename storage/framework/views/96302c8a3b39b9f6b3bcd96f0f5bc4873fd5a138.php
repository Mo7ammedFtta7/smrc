<div class="btn-group slider-slider">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[name]" class="col-sm-2 control-label">
                                        <?php echo trans('slider::slider.label.name'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title1]" class="col-sm-2 control-label">
                                        <?php echo trans('slider::slider.label.title1'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[title1]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        <?php echo trans('slider::slider.label.status'); ?>
...
$(document).ready(function(){
    ...
    $(".slider-slider .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/slider.slider.search'); ?>");
        $('#modal-open').modal("show");
    });

   $(".slider-slider .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.slider-slider .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'slider.slider.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#slider-slider-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#slider-slider-list .btn-reset-filter').css('display', 'none');
