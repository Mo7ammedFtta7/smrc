                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[id]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.id'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[id]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[category_id]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.category_id'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[category_id]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.title'); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[viewcount]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.viewcount'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[viewcount]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.published'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[published]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published_at]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.published_at'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[published_at]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[user_type]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.user_type'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[user_type]')->raw(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[created_at]" class="col-sm-2 control-label">
                                        <?php echo trans('blog::blog.label.created_at'); ?>

                                    </label>
                                    <div class="col-sm-10">
                                        <?php echo Form::text('search[created_at]')->raw(); ?>
...
$(document).ready(function(){
    ...
    $(".blog-blog .btn-open").click(function(){
        ...
        return false;
        $('#open-list').load("<?php echo guard_url('/settings/setting/search/blog.blog.search'); ?>");
