    ...
    <div id='page-page-entry'>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                    ...
                    <li class="pull-right">
                    <span class="actions">   
                    <?php echo $__env->make('page::admin.page.partial.filter', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo $__env->make('page::admin.page.partial.column', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </span> 
                </li>
            </ul>
